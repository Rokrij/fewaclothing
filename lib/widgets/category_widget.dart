...
import 'package:fewaclothing/category_details.dart';
...
class CategoryWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        Navigator.push(context, PageTransition(type: PageTransitionType.leftToRightWithFade, child: CategoryDetails()));
      },
      child: Column(
        children: [
          ClipRRect(
